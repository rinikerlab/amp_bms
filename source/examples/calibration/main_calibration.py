...
def main():
    ...
    if (parameters["tip4p"] and not parameters["continue_simulation"]):
    ...
    if (parameters["use_AMP"]):
        ...
        if (not parameters["alchemical_FE"]):
            ...
            amp_configurator = AmpConfigurator(system=system,
                                   ...
                                   device_ml=parameters["device_ml"],
                                   mol_charge=parameters["mol_charge"], 
                                   scaling_lj_qm_mm=parameters["alchemical_FE_definition"]["scaling_factor_lj_qmmm"],
                                   scaling_factor_alchemical_coulomb=parameters["alchemical_FE_definition"]["scaling_factor_coulomb_qmmm"],
                                   scaling_charges=parameters["scaling_charges"],
